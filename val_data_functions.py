...
class MyValData(data.Dataset):
    def __init__(self, val_data_dir):
        ...
        self.input_names = os.listdir(val_data_dir)
        self.input_names.remove('.DS_Store')
        # self.gt_names = gt_names
        self.val_data_dir = val_data_dir
        # print(input_names)
        # print(gt_names)
    ...
    def get_images(self, index):
        input_name = self.input_names[index]
        # gt_name = self.gt_names[index]
        #print("input image it looks for",os.path.join(self.val_data_dir,input_name))
